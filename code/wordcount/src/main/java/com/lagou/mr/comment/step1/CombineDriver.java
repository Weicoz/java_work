...
//        5. 指定最终输出的kv数据类型
        ...
        FileInputFormat.setInputPaths(job, new Path("E:\\teach\\hadoop框架\\资料\\data\\mr综合案例\\input")); //指定读取数据的原始路径
//        7. 指定job输出结果路径
        FileOutputFormat.setOutputPath(job, new Path("E:\\teach\\hadoop框架\\资料\\data\\mr综合案例\\merge-out")); //指定结果数据输出路径
